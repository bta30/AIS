...
const int minStarArea = 8;
const int comparedTris = 128;
const int maxCompareTris = 512;
const int chosenTris = 16;
const double maxError = 16.0;
...
int getStar(int* image, int x, int y, int width, int height, vec2* centre); // Get the centre of the star starting at a particular coordinate given, erasing it, returns 0 if the star given is invalid
